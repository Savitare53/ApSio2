               ...
               <div class="right-header">
                  <div class="header-info">
                     ...
                     <div class="info-inner">
                        ...
                        <span class="iconcont"><a data-scroll href="mailto:info@yoursite.com">nanobio0rganics.com</a></span>	
                     </div>
                     <div class="info-inner">
                        <span class="icontop"><i class="fa fa-clock-o" aria-hidden="true"></i></span>
                        <span class="iconcont"><a data-scroll href="#">Daily: 00:01am - 00:00pm</a></span>	
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="col-md-12 col-sm-12">
                  <div class="text-contant">
                     <h2>
                        ...
                        <a href="" class="typewrite" data-period="2000" data-type='[ "Welcome to NanoBio", "", "We are Expert!" ]'>
               ...
               <div class="row">
                  <div class="service-time middle" style="background:#0071d1;">
                     ...
                     <div class="time-table-section">
                        <ul>
                           <li><span class="left">Lundi - Dimanche</span><span class="right">24/24h</span></li>
                          <p>Trois équipes se succède pour pouvoir repondre a la demande le plus vite possible</p>
                        </ul>
                     </div>
                  </div>
               </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.2s; animation-name: fadeIn;">
                    <div class="widget clearfix">
                        ...
                        <div class="footer-social">
                            ...
                            <a href="#" class="btn grd1"><i class="fa fa-instagram"></i></a>
                        </div>
                    </div><!--widget -->
                </div><!-- end col -->
            ...
            <div class="row">
               ...
               <div class="col-md-4">
                  <div class="footer-info padding">
                     ...
                     <p><i class="fa fa-paper-plane" aria-hidden="true"></i> nanobio0rganics@gmail.com</p>
                     <p><i class="fa fa-phone" aria-hidden="true"></i> (+33) 800 123 456</p>
                  </div>
               </div>
               <div class="col-md-4">
            ...
            <div class="row">
               <div class="col-md-8">
                  <div class="footer-text">
                     <p>© 2018 NanoBio Organics All Rights Reserved.</p>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="social">
